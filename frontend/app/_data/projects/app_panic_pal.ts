...
export const panic_pal: ProjectType = {
    ...
    details: {
        company: "Western Washington University, Human Centered Design",
        dates: {
            start_date: "2023-09",
            end_date: "2023-12"
        },
    ...
    caseStudy: {
        ...
        challenges: [
            "The consideration of how to save chat history for privacy and storage reasons. After concluding a chat, the chatbot has ChatGPT provide a summary of the chat and stores the response in local storage. When the application is reopened, the chatbot initializes a new chat with ChatGPT with the summary in the background to ensure personalize results and tailored solutions are used."
        ]
    }
}